...
const TON1 = require("./TON.json");
const WTON1 = require("./WTON.json");
...
class ICO20Contracts {
  ...
  addStake2LogicAndVault2Factory  = async function (owner1) {
    ...
    await this.stake1proxy
      .connect(owner)
      .setSelectorImplementations([_func1, _func2, _func3, _func4, _func5, _func6, _func7, _func8], this.stake2logic.address);
